...
from chatbot.parsers.docx_parser import parse_docx
from chatbot.parsers.pdf_parser import parse_pdf
from chatbot.parsers.txt_parser import parse_text
from chatbot.parsers.types import ParsedDocument, ParsedPage
from chatbot.parsers.xlsx_parser import parse_xlsx
...
_MIME_DISPATCH = {
    ...
    "application/msword": parse_docx,  # some clients send this for .docx
