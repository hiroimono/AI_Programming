...
export async function openSession(apiBase: string, botId: string, tenantId: string): Promise<SessionResponse> {
...
export async function streamChat(apiBase: string, token: string, message: string, conversationId: string | null): Promise<Response> {
